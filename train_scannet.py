...
train_set = ScanNetDataset(args, train=True)
val_set = ScanNetDataset(args, train=False)

train_sampler = ScanNetSampler(train_set)
val_sampler = ScanNetSampler(val_set)
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        losses, loss_names, accuracy_train = train(kpconv_net, optimizer)
        errors, error_names, accuracy_val, mean_iou = validate(kpconv_net)
