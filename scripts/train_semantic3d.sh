...
TRAIN_SET = $DATA_ROOT/data/point_cloud/semantic3d
python train.py $TRAIN_SET \
--dataset_name 'semantic3d'  --model_name 'KPConv_Net'  --task 'segmentation'  --seed 2048 \
--workers 8  --epochs 100  --batch_size 10  --epoch_steps 500 \
